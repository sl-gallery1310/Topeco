 ...
 *   npm run db:seed
 */
import { PrismaClient, Material, AgecStatus, ResellerType, ResellerStatus, TerritoryStatus, UserRole, OrderStatus, QuoteStatus } from "@prisma/client";
...
async function main() {
  ...
  const cEmballages = await db.category.upsert({
    ...
    create: {
      ...
      imageUrl: "/uploads/app-packaging.png",
      imageAlt: "Barquettes et boîtes repas TOPECO en fibre moulée",
      sortOrder: 1,
    },
  });
  const cConsommables = await db.category.upsert({
    ...
    create: {
      ...
      imageUrl: "/uploads/photo-products.png",
      imageAlt: "Consommables TOPECO : couverts bois et serviettes kraft",
      sortOrder: 2,
    },
  });
  ...
  const products: Seed[] = [
    { sku: "TPE-EMB-BFM750", slug: "barquette-fibre-moulee-750ml", categoryId: cEmballages.id, name: "Barquette fibre moulée 750 ml", lotLabel: "Lot de 300 · avec couvercle", priceHt: eur(39.90), material: Material.FIBRE_MOULEE, capacityMl: 750 },
    { sku: "TPE-EMB-SKP250", slug: "sac-kraft-poignees-plates", categoryId: cEmballages.id, name: "Sac kraft à poignées plates", lotLabel: "Lot de 250 · 26 × 17 × 32 cm", priceHt: eur(21.50), material: Material.KRAFT_BRUT },
    { sku: "TPE-EMB-GDP250", slug: "gobelet-double-paroi-25cl", categoryId: cEmballages.id, name: "Gobelet double paroi 25 cl", lotLabel: "Lot de 500 · couvercles inclus", priceHt: eur(29.90), material: Material.CARTON_CERTIFIE, capacityMl: 250 },
    { sku: "TPE-EMB-BRC1000", slug: "boite-repas-carton-1000ml", categoryId: cEmballages.id, name: "Boîte repas carton 1 000 ml", lotLabel: "Lot de 200 · barrière aqueuse", priceHt: eur(34.20), material: Material.CARTON_CERTIFIE, capacityMl: 1000 },
    { sku: "TPE-EMB-PSI1000", slug: "pochette-sandwich-ingraissable", categoryId: cEmballages.id, name: "Pochette sandwich ingraissable", lotLabel: "Lot de 1 000 · kraft brun", priceHt: eur(15.60), material: Material.KRAFT_BRUT },
    { sku: "TPE-EMB-CPET750", slug: "couvercle-pet-recycle-750ml", categoryId: cEmballages.id, name: "Couvercle PET recyclé 750 ml", lotLabel: "Lot de 300 · compatible barquette fibre", priceHt: eur(18.40), material: Material.PET_RECYCLE, capacityMl: 750, agec: AgecStatus.A_SURVEILLER },
