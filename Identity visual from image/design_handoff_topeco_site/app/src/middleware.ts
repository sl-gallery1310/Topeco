...
/**
 * Garde-fou léger : redirige vers la connexion si aucun cookie de session n’est présent.
 * La vérification réelle des droits reste côté serveur (requireAdmin / requireClient),
 * car le middleware n’a pas accès à la base.
 */
