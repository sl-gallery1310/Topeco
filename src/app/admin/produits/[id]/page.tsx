...
export default async function AdminProductEdit({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Objet intermédiaire : le spread porte des colonnes que ProductForm n'utilise
  // pas (images, dates…). Passé directement en prop, TypeScript refuserait le
  // littéral pour propriétés surnuméraires.
